...
#
#
export CC_FLAGS_QPY=" -std=c99 --sysroot ${ANDROID_NDK}/platforms/android-${ANDROID_VER}/arch-arm -I${ANDROID_NDK}/sysroot/usr/include -I${ANDROID_NDK}/sysroot/usr/include/arm-linux-androideabi -D__ANDROID_API__=${ANDROID_VER}"
...
#
export LDFLAGS_QPY="--sysroot ${ANDROID_NDK}/platforms/android-${ANDROID_VER}/arch-arm -L${ANDROID_NDK}/platforms/android-${ANDROID_VER}/arch-arm/usr/lib -L${ANDROID_NDK}/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/lib/gcc/arm-linux-androideabi/4.9.x -lgcc -shared"
#
...
#export CC="${ANDROID_NDK}/toolchains/llvm/prebuilt/${HST}-x86_64/bin/clang ${CLANG_FLAGS_QPY} ${LDFLAGS_QPY}"
#export CXX="${ANDROID_NDK}/toolchains/llvm/prebuilt/${HST}-x86_64/bin/clang++ ${CLANG_FLAGS_QPY} ${LDFLAGS_QPY}"
#
