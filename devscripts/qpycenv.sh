...
export CC="${ANDROID_NDK}/toolchains/llvm/prebuilt/linux-x86_64/bin/clang ${CLANG_FLAGS_QPY} ${LDFLAGS}"
export CXX="${ANDROID_NDK}/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ ${CLANG_FLAGS_QPY} ${LDFLAGS}"
